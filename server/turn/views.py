    ...
    def post(self, request):
        ...
        try:      
            send_email_to_user(
                ...
                f"Puedes calificar a {name_received} en el siguiente enlace: http://localhost:5173/ratings/rate/M/{id_turn} \n" +
            ...
            send_email_to_user(
                ...
                f"Puedes calificar a {name_maker} en el siguiente enlace: http://localhost:5173/ratings/rate/R/{id_turn} \n" +
                f"¡Gracias por confiar en SwapIt!"
            )
        except:
            return Response(
        ...
        turn.state = TurnState.objects.get(name="sin calificar")
...
class RetrieveTurnView(generics.RetrieveAPIView):
    queryset = Turn.objects.filter(state_id=4)
